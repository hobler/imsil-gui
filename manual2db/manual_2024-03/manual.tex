...
\section{Ion Beam}
\label{s:beam}
\input{iontarg_beam.tex}
%
\section{Material}
\label{s:mater}
\input{iontarg_material.tex}
%
\section{Geometry}
\label{s:geometry}
\input{iontarg_geometry.tex}
%
\section{Dynamic Target Updates}
\label{s:updates}
\input{iontarg_updates.tex}
%
%%%%%%%%%%%%%
% Chapter 3 %
%%%%%%%%%%%%%
...
\section{\texttt{\&SETUP} ~}
\label{s:setup}
\input{param_setup.tex}
%
\newpage
\section{\texttt{\&GEOMETRY} ~}
\label{s:geom}
\input{param_geometry.tex}
%
\newpage
\section{\texttt{\&ATOMS} ~}
\label{s:atom}
\input{param_atoms.tex}
%
\newpage
\section{\texttt{\&IONS} ~}
\label{s:ion}
\input{param_ions.tex}
%
\newpage
\section{\texttt{\&CRYSTAL} ~}
\label{s:xtal}
\input{param_crystal.tex}
%
\newpage
\section{\texttt{\&MATERIAL} ~}
\label{s:target}
\input{param_material.tex}
%
\newpage
\section{\texttt{\&DAMAGE} ~}
\label{s:damage}
\input{param_damage.tex}
%
\newpage
\section{\texttt{\&SNPAR} ~}
\label{s:snpar}
\input{param_snpar.tex}
%
\newpage
\section{\texttt{\&SEPAR} ~}
\label{s:separ}
\input{param_separ.tex}
%
\newpage
\section{\texttt{\&OUTPUT} ~}
\label{s:output}
\input{param_output.tex}
%
%%%%%%%%%%%%%
% Chapter 6 %
%%%%%%%%%%%%%
...
\input{ex_sput_stat.tex}
% Ar

\section{Dynamic Sputtering}
\input{ex_sput_dyn.tex}
% krdyn
